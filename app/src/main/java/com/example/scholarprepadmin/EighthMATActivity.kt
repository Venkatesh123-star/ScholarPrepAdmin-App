...
import com.example.scholarprepadmin.databinding.ActivityEighthMatactivityBinding
import com.example.scholarprepadmin.databinding.ActivityFifthMatactivityBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import org.json.JSONObject

class EighthMATActivity : AppCompatActivity() {

    private lateinit var binding: ActivityEighthMatactivityBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "mentalAbilityTest_8th_class"
    private val db = FirebaseFirestore.getInstance()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding= ActivityEighthMatactivityBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Mental Ability Test - Eighth"
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.setDisplayShowHomeEnabled(true)

        binding.addquestion.setOnClickListener {
            val intent = Intent(this, AddQuestionActivity::class.java)
            intent.putExtra("collectionName", "mentalAbilityTest_8th_class")
