...
import com.example.scholarprepadmin.databinding.ActivityEighthEnglishBinding
import com.example.scholarprepadmin.databinding.ActivityFifthEnglishBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import org.json.JSONObject

class EighthEnglishActivity : AppCompatActivity() {

    private lateinit var binding: ActivityEighthEnglishBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "english_8th_class"
    private val db = FirebaseFirestore.getInstance()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding= ActivityEighthEnglishBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "English - Eighth"
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.setDisplayShowHomeEnabled(true)

        binding.addquestion.setOnClickListener {
            val intent = Intent(this, AddQuestionActivity::class.java)
            intent.putExtra("collectionName", "english_8th_class")
