...
class FifthEnglishActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFifthEnglishBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "english_5th_class"
    private val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding= ActivityFifthEnglishBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "English - Fifth"
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.setDisplayShowHomeEnabled(true)

        binding.addquestion.setOnClickListener {
            val intent = Intent(this, AddQuestionActivity::class.java)
            intent.putExtra("collectionName", "english_5th_class")
