...
import com.example.scholarprepadmin.databinding.ActivityEighthMarathiBinding
import com.example.scholarprepadmin.databinding.ActivityFifthMarathiBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import org.json.JSONObject

class EighthMarathiActivity : AppCompatActivity() {

    private lateinit var binding: ActivityEighthMarathiBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "marathi_8th_class"
    private val db = FirebaseFirestore.getInstance()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding= ActivityEighthMarathiBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Marathi - Eighth"
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.setDisplayShowHomeEnabled(true)

        binding.addquestion.setOnClickListener {
            val intent = Intent(this, AddQuestionActivity::class.java)
            intent.putExtra("collectionName", "marathi_8th_class")
