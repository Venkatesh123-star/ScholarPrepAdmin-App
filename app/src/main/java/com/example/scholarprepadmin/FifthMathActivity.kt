...
class FifthMathActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFifthMathBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "mathematics_5th_class"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding= ActivityFifthMathBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Mathematics - Fifth"
        ...
        binding.addquestion.setOnClickListener {
            ...
            intent.putExtra("collectionName", "mathematics_5th_class")
