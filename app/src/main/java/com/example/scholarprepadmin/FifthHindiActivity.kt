...
class FifthHindiActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFifthHindiBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "hindi_5th_class"
    private val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityFifthHindiBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Hindi - Fifth"
        ...
        binding.addquestion.setOnClickListener {
            ...
            intent.putExtra("collectionName","hindi_5th_class")
