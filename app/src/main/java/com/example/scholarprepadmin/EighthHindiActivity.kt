...
import com.example.scholarprepadmin.databinding.ActivityEighthHindiBinding
import com.example.scholarprepadmin.databinding.ActivityFifthHindiBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import org.json.JSONObject

class EighthHindiActivity : AppCompatActivity() {

    private lateinit var binding: ActivityEighthHindiBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "hindi_8th_class"
    private val db = FirebaseFirestore.getInstance()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityEighthHindiBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Hindi - Eighth"
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.setDisplayShowHomeEnabled(true)

        binding.addquestion.setOnClickListener {
            val intent = Intent(this, AddQuestionActivity::class.java)
            intent.putExtra("collectionName", "hindi_8th_class")
