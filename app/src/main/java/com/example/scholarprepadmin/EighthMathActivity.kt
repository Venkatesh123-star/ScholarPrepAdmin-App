...
import com.example.scholarprepadmin.databinding.ActivityEighthMathBinding
import com.example.scholarprepadmin.databinding.ActivityFifthMathBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import org.json.JSONObject

class EighthMathActivity : AppCompatActivity() {

    private lateinit var binding: ActivityEighthMathBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "mathematics_8th_class"
    private val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding= ActivityEighthMathBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Mathematics - Eighth"
        ...
        binding.addquestion.setOnClickListener {
            ...
            intent.putExtra("collectionName", "mathematics_8th_class")
