...
class FifthMarathiActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFifthMarathiBinding
    private var pdfUri: Uri? = null
    private var selectedTopic = ""
    private val collectionName = "marathi_5th_class"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding= ActivityFifthMarathiBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Marathi - Fifth"
        ...
        binding.addquestion.setOnClickListener {
            ...
            intent.putExtra("collectionName", "marathi_5th_class")
